...
lift(docker_input)
# if you are on mac, define pre-build command to start docker first
prebuild = "docker-machine start default;docker-machine env default;eval \"$(docker-machine env default)\""
drender(docker_input, prebuild = prebuild)
```
